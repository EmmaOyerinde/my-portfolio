    ...
    function initReliabilityMap(utilitiesGeoJSON, canadaBounds) {
        ...
        let geojsonLayer = L.geoJSON(utilitiesGeoJSON, { 
            ...
            style: function(f) { 
                ...
                // GHOST LAYER LOGIC:
                let polyFillOpacity = isHydroOne ? 0.06 : (isProv ? 0.15 : 0.35);
                let borderOpacity = isHydroOne ? 0.0 : (isProv ? 0.4 : 0.8);
                ...
                return { 
                    ...
                    lineJoin: 'round', 
                    lineCap: 'round',
                    className: isHydroOne ? 'ghost-layer' : '' 
                }; 
            }, 
            onEachFeature: function(f, layer) {
                ...
                // Hover Dynamics: Polygon opacity increases heavily when hovered to make it "pop"
                layer.on({ 
                    mouseover: (e) => { 
